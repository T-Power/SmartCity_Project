...
public class SmartCityPackageImpl extends EPackageImpl implements SmartCityPackage {
	 ...
	 * @generated
	 */
	private EClass smartCityBaseEClass = null;
	 ...
	 * @generated
	 */
	public EClass getSmartCityBase() {
		return smartCityBaseEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSmartCityBase_CityName() {
		return (EAttribute)smartCityBaseEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getSmartCityBase_CityDevices() {
		return (EReference)smartCityBaseEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getSmartCityBase_Institutions() {
		return (EReference)smartCityBaseEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		smartCityBaseEClass = createEClass(SMART_CITY_BASE);
		createEAttribute(smartCityBaseEClass, SMART_CITY_BASE__CITY_NAME);
		createEReference(smartCityBaseEClass, SMART_CITY_BASE__CITY_DEVICES);
		createEReference(smartCityBaseEClass, SMART_CITY_BASE__INSTITUTIONS);
	...
	public void initializePackageContents() {
		...
		initEClass(smartCityBaseEClass, SmartCityBase.class, "SmartCityBase", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSmartCityBase_CityName(), ecorePackage.getEString(), "cityName", null, 0, 1, SmartCityBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSmartCityBase_CityDevices(), this.getCityDevice(), null, "cityDevices", null, 0, -1, SmartCityBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSmartCityBase_Institutions(), this.getInstitution(), null, "institutions", null, 0, -1, SmartCityBase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
