 ...
 * </p>
 * <ul>
 *   <li>{@link SmartCity.impl.SmartCityBaseImpl#getCityName <em>City Name</em>}</li>
 *   <li>{@link SmartCity.impl.SmartCityBaseImpl#getCityDevices <em>City Devices</em>}</li>
 *   <li>{@link SmartCity.impl.SmartCityBaseImpl#getInstitutions <em>Institutions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SmartCityBaseImpl extends MinimalEObjectImpl.Container implements SmartCityBase {
	/**
	...
	protected EClass eStaticClass() {
		return SmartCityPackage.Literals.SMART_CITY_BASE;
	}
	...
	public void setCityName(String newCityName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartCityPackage.SMART_CITY_BASE__CITY_NAME, oldCityName, cityName));
	}
	...
	public EList<CityDevice> getCityDevices() {
		if (cityDevices == null) {
			cityDevices = new EObjectContainmentEList<CityDevice>(CityDevice.class, this, SmartCityPackage.SMART_CITY_BASE__CITY_DEVICES);
		}
		return cityDevices;
	}
	...
	public EList<Institution> getInstitutions() {
		if (institutions == null) {
			institutions = new EObjectContainmentEList<Institution>(Institution.class, this, SmartCityPackage.SMART_CITY_BASE__INSTITUTIONS);
		}
		return institutions;
	}
