...
public class SmartCityFactoryImpl extends EFactoryImpl implements SmartCityFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SmartCityPackage.SMART_CITY_BASE: return createSmartCityBase();
	 ...
	 * @generated
	 */
	public SmartCityBase createSmartCityBase() {
		SmartCityBaseImpl smartCityBase = new SmartCityBaseImpl();
		return smartCityBase;
	}
