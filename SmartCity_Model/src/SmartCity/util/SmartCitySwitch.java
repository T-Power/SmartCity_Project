...
public class SmartCitySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SmartCityPackage.SMART_CITY_BASE: {
				SmartCityBase smartCityBase = (SmartCityBase)theEObject;
				T result = caseSmartCityBase(smartCityBase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SmartCityPackage.CITY_DEVICE: {
				CityDevice cityDevice = (CityDevice)theEObject;
				T result = caseCityDevice(cityDevice);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SmartCityPackage.CONTROL_UNIT: {
	 ...
	 * @generated
	 */
	public T caseSmartCityBase(SmartCityBase object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>City Device</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>City Device</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCityDevice(CityDevice object) {
		return null;
	}
