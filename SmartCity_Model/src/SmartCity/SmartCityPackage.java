...
public interface SmartCityPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SMART_CITY__CITY_DEVICES = 1;
	 ...
	 * @ordered
	 */
	int SMART_CITY__INSTITUTIONS = 2;
	 ...
	 * @ordered
	 */
	int SMART_CITY_FEATURE_COUNT = 3;
	...
	/**
	 * Returns the meta object for the attribute '{@link SmartCity.SmartCity#getCityName <em>City Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>City Name</em>'.
	 * @see SmartCity.SmartCity#getCityName()
	 * @see #getSmartCity()
	 * @generated
	 */
	EAttribute getSmartCity_CityName();

	/**
	 * Returns the meta object for the containment reference list '{@link SmartCity.SmartCity#getCityDevices <em>City Devices</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>City Devices</em>'.
	 * @see SmartCity.SmartCity#getCityDevices()
	 * @see #getSmartCity()
	 * @generated
	 */
	EReference getSmartCity_CityDevices();

	/**
	 * Returns the meta object for the containment reference list '{@link SmartCity.SmartCity#getInstitutions <em>Institutions</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Institutions</em>'.
	 * @see SmartCity.SmartCity#getInstitutions()
	 * @see #getSmartCity()
	 * @generated
	 */
	EReference getSmartCity_Institutions();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute SMART_CITY__CITY_NAME = eINSTANCE.getSmartCity_CityName();
		 ...
		 * @generated
		 */
		EReference SMART_CITY__CITY_DEVICES = eINSTANCE.getSmartCity_CityDevices();
		 ...
		 * @generated
		 */
		EReference SMART_CITY__INSTITUTIONS = eINSTANCE.getSmartCity_Institutions();
